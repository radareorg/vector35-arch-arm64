...
#define ADD_OPERAND_MEM_EXTENDED_SZ_SHIFT( \
...
#define ADD_OPERAND_VREG_T(ARR_SPEC, REGNUM) ADD_OPERAND_REG_T(REG_V_BASE, ARR_SPEC, REGNUM)
...
#define ADD_OPERAND_ZREG_T(ARR_SPEC, REGNUM) ADD_OPERAND_REG_T(REG_Z_BASE, ARR_SPEC, REGNUM)
...
#define ADD_OPERAND_VREG_TA_LANED(REGNUM, INDEX) \
	ADD_OPERAND_VREG_ESIZE_LANED(arr_spec_a, REGNUM, INDEX)
#define ADD_OPERAND_VREG_TB_LANED(REGNUM, INDEX) \
	ADD_OPERAND_VREG_ESIZE_LANED(arr_spec_b, REGNUM, INDEX)
#define ADD_OPERAND_VREG_TS_LANED(REGNUM, INDEX) \
	ADD_OPERAND_VREG_ESIZE_LANED(arr_spec_s, REGNUM, INDEX)
...
int decode_scratchpad(context* ctx, Instruction* instr)
{
	...
	case ENC_PRFH_I_P_BR_S:
	{
		...
		ADD_OPERAND_PRED_REG(ctx->g);
		ADD_OPERAND_MEM_EXTENDED_SZ_SHIFT(
